...
const Recipe = ({ recipe }) => {
    const { recipe_name, recipe_img, recipe_des, ingredients_num, ingredient_name, cooking_time } = recipe;
        ...
        <>
            <div className="flex flex-col space-y-6 px-6 py-6 border-2 rounded-2xl">
                ...
                <div className="flex gap-4 grow items-start">
                    ...
                    <p className="flex justify-center items-center gap-2 text-Black80"><AiOutlineFire />{cooking_time}</p>
                </div>
                <SecondaryBtn BtnTitle={'Want to Cook'}></SecondaryBtn>
